 ...
 */var Jm;function Yw(){if(Jm)return xe;Jm=1;var r=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),_=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),T=Symbol.iterator;function R(V){return V===null||typeof V!="object"?null:(V=T&&V[T]||V["@@iterator"],typeof V=="function"?V:null)}var z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},W=Object.assign,$={};function B(V,q,Ae){this.props=V,this.context=q,this.refs=$,this.updater=Ae||z}B.prototype.isReactComponent={},B.prototype.setState=function(V,q){if(typeof V!="object"&&typeof V!="function"&&V!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,V,q,"setState")},B.prototype.forceUpdate=function(V){this.updater.enqueueForceUpdate(this,V,"forceUpdate")};function ae(){}ae.prototype=B.prototype;function ue(V,q,Ae){this.props=V,this.context=q,this.refs=$,this.updater=Ae||z}var ne=ue.prototype=new ae;ne.constructor=ue,W(ne,B.prototype),ne.isPureReactComponent=!0;var pe=Array.isArray,Ce=Object.prototype.hasOwnProperty,Te={current:null},k={key:!0,ref:!0,__self:!0,__source:!0};function A(V,q,Ae){var Re,ke={},Ne=null,ze=null;if(q!=null)for(Re in q.ref!==void 0&&(ze=q.ref),q.key!==void 0&&(Ne=""+q.key),q)Ce.call(q,Re)&&!k.hasOwnProperty(Re)&&(ke[Re]=q[Re]);var Me=arguments.length-2;if(Me===1)ke.children=Ae;else if(1<Me){for(var He=Array(Me),$t=0;$t<Me;$t++)He[$t]=arguments[$t+2];ke.children=He}if(V&&V.defaultProps)for(Re in Me=V.defaultProps,Me)ke[Re]===void 0&&(ke[Re]=Me[Re]);return{$$typeof:r,type:V,key:Ne,ref:ze,props:ke,_owner:Te.current}}function x(V,q){return{$$typeof:r,type:V.type,key:q,ref:V.ref,props:V.props,_owner:V._owner}}function N(V){return typeof V=="object"&&V!==null&&V.$$typeof===r}function b(V){var q={"=":"=0",":":"=2"};return"$"+V.replace(/[=:]/g,function(Ae){return q[Ae]})}var D=/\/+/g;function I(V,q){return typeof V=="object"&&V!==null&&V.key!=null?b(""+V.key):q.toString(36)}function Pe(V,q,Ae,Re,ke){var Ne=typeof V;(Ne==="undefined"||Ne==="boolean")&&(V=null);var ze=!1;if(V===null)ze=!0;else switch(Ne){case"string":case"number":ze=!0;break;case"object":switch(V.$$typeof){case r:case e:ze=!0}}if(ze)return ze=V,ke=ke(ze),V=Re===""?"."+I(ze,0):Re,pe(ke)?(Ae="",V!=null&&(Ae=V.replace(D,"$&/")+"/"),Pe(ke,q,Ae,"",function($t){return $t})):ke!=null&&(N(ke)&&(ke=x(ke,Ae+(!ke.key||ze&&ze.key===ke.key?"":(""+ke.key).replace(D,"$&/")+"/")+V)),q.push(ke)),1;if(ze=0,Re=Re===""?".":Re+":",pe(V))for(var Me=0;Me<V.length;Me++){Ne=V[Me];var He=Re+I(Ne,Me);ze+=Pe(Ne,q,Ae,He,ke)}else if(He=R(V),typeof He=="function")for(V=He.call(V),Me=0;!(Ne=V.next()).done;)Ne=Ne.value,He=Re+I(Ne,Me++),ze+=Pe(Ne,q,Ae,He,ke);else if(Ne==="object")throw q=String(V),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(V).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.");return ze}function rt(V,q,Ae){if(V==null)return V;var Re=[],ke=0;return Pe(V,Re,"","",function(Ne){return q.call(Ae,Ne,ke++)}),Re}function vt(V){if(V._status===-1){var q=V._result;q=q(),q.then(function(Ae){(V._status===0||V._status===-1)&&(V._status=1,V._result=Ae)},function(Ae){(V._status===0||V._status===-1)&&(V._status=2,V._result=Ae)}),V._status===-1&&(V._status=0,V._result=q)}if(V._status===1)return V._result.default;throw V._result}var qe={current:null},te={transition:null},fe={ReactCurrentDispatcher:qe,ReactCurrentBatchConfig:te,ReactCurrentOwner:Te};function se(){throw Error("act(...) is not supported in production builds of React.")}return xe.Children={map:rt,forEach:function(V,q,Ae){rt(V,function(){q.apply(this,arguments)},Ae)},count:function(V){var q=0;return rt(V,function(){q++}),q},toArray:function(V){return rt(V,function(q){return q})||[]},only:function(V){if(!N(V))throw Error("React.Children.only expected to receive a single React element child.");return V}},xe.Component=B,xe.Fragment=t,xe.Profiler=o,xe.PureComponent=ue,xe.StrictMode=s,xe.Suspense=g,xe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fe,xe.act=se,xe.cloneElement=function(V,q,Ae){if(V==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+V+".");var Re=W({},V.props),ke=V.key,Ne=V.ref,ze=V._owner;if(q!=null){if(q.ref!==void 0&&(Ne=q.ref,ze=Te.current),q.key!==void 0&&(ke=""+q.key),V.type&&V.type.defaultProps)var Me=V.type.defaultProps;for(He in q)Ce.call(q,He)&&!k.hasOwnProperty(He)&&(Re[He]=q[He]===void 0&&Me!==void 0?Me[He]:q[He])}var He=arguments.length-2;if(He===1)Re.children=Ae;else if(1<He){Me=Array(He);for(var $t=0;$t<He;$t++)Me[$t]=arguments[$t+2];Re.children=Me}return{$$typeof:r,type:V.type,key:ke,ref:Ne,props:Re,_owner:ze}},xe.createContext=function(V){return V={$$typeof:h,_currentValue:V,_currentValue2:V,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},V.Provider={$$typeof:u,_context:V},V.Consumer=V},xe.createElement=A,xe.createFactory=function(V){var q=A.bind(null,V);return q.type=V,q},xe.createRef=function(){return{current:null}},xe.forwardRef=function(V){return{$$typeof:m,render:V}},xe.isValidElement=N,xe.lazy=function(V){return{$$typeof:w,_payload:{_status:-1,_result:V},_init:vt}},xe.memo=function(V,q){return{$$typeof:_,type:V,compare:q===void 0?null:q}},xe.startTransition=function(V){var q=te.transition;te.transition={};try{V()}finally{te.transition=q}},xe.unstable_act=se,xe.useCallback=function(V,q){return qe.current.useCallback(V,q)},xe.useContext=function(V){return qe.current.useContext(V)},xe.useDebugValue=function(){},xe.useDeferredValue=function(V){return qe.current.useDeferredValue(V)},xe.useEffect=function(V,q){return qe.current.useEffect(V,q)},xe.useId=function(){return qe.current.useId()},xe.useImperativeHandle=function(V,q,Ae){return qe.current.useImperativeHandle(V,q,Ae)},xe.useInsertionEffect=function(V,q){return qe.current.useInsertionEffect(V,q)},xe.useLayoutEffect=function(V,q){return qe.current.useLayoutEffect(V,q)},xe.useMemo=function(V,q){return qe.current.useMemo(V,q)},xe.useReducer=function(V,q,Ae){return qe.current.useReducer(V,q,Ae)},xe.useRef=function(V){return qe.current.useRef(V)},xe.useState=function(V){return qe.current.useState(V)},xe.useSyncExternalStore=function(V,q,Ae){return qe.current.useSyncExternalStore(V,q,Ae)},xe.useTransition=function(){return qe.current.useTransition()},xe.version="18.3.1",xe}var Xm;function Yd(){return Xm||(Xm=1,Xh.exports=Yw()),Xh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var tg;function e0(){return tg||(tg=1,(function(r){function e(te,fe){var se=te.length;te.push(fe);e:for(;0<se;){var V=se-1>>>1,q=te[V];if(0<o(q,fe))te[V]=fe,te[se]=q,se=V;else break e}}function t(te){return te.length===0?null:te[0]}function s(te){if(te.length===0)return null;var fe=te[0],se=te.pop();if(se!==fe){te[0]=se;e:for(var V=0,q=te.length,Ae=q>>>1;V<Ae;){var Re=2*(V+1)-1,ke=te[Re],Ne=Re+1,ze=te[Ne];if(0>o(ke,se))Ne<q&&0>o(ze,ke)?(te[V]=ze,te[Ne]=se,V=Ne):(te[V]=ke,te[Re]=se,V=Re);else if(Ne<q&&0>o(ze,se))te[V]=ze,te[Ne]=se,V=Ne;else break e}}return fe}function o(te,fe){var se=te.sortIndex-fe.sortIndex;return se!==0?se:te.id-fe.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();r.unstable_now=function(){return h.now()-m}}var g=[],_=[],w=1,T=null,R=3,z=!1,W=!1,$=!1,B=typeof setTimeout=="function"?setTimeout:null,ae=typeof clearTimeout=="function"?clearTimeout:null,ue=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ne(te){for(var fe=t(_);fe!==null;){if(fe.callback===null)s(_);else if(fe.startTime<=te)s(_),fe.sortIndex=fe.expirationTime,e(g,fe);else break;fe=t(_)}}function pe(te){if($=!1,ne(te),!W)if(t(g)!==null)W=!0,vt(Ce);else{var fe=t(_);fe!==null&&qe(pe,fe.startTime-te)}}function Ce(te,fe){W=!1,$&&($=!1,ae(A),A=-1),z=!0;var se=R;try{for(ne(fe),T=t(g);T!==null&&(!(T.expirationTime>fe)||te&&!b());){var V=T.callback;if(typeof V=="function"){T.callback=null,R=T.priorityLevel;var q=V(T.expirationTime<=fe);fe=r.unstable_now(),typeof q=="function"?T.callback=q:T===t(g)&&s(g),ne(fe)}else s(g);T=t(g)}if(T!==null)var Ae=!0;else{var Re=t(_);Re!==null&&qe(pe,Re.startTime-fe),Ae=!1}return Ae}finally{T=null,R=se,z=!1}}var Te=!1,k=null,A=-1,x=5,N=-1;function b(){return!(r.unstable_now()-N<x)}function D(){if(k!==null){var te=r.unstable_now();N=te;var fe=!0;try{fe=k(!0,te)}finally{fe?I():(Te=!1,k=null)}}else Te=!1}var I;if(typeof ue=="function")I=function(){ue(D)};else if(typeof MessageChannel<"u"){var Pe=new MessageChannel,rt=Pe.port2;Pe.port1.onmessage=D,I=function(){rt.postMessage(null)}}else I=function(){B(D,0)};function vt(te){k=te,Te||(Te=!0,I())}function qe(te,fe){A=B(function(){te(r.unstable_now())},fe)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(te){te.callback=null},r.unstable_continueExecution=function(){W||z||(W=!0,vt(Ce))},r.unstable_forceFrameRate=function(te){0>te||125<te?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):x=0<te?Math.floor(1e3/te):5},r.unstable_getCurrentPriorityLevel=function(){return R},r.unstable_getFirstCallbackNode=function(){return t(g)},r.unstable_next=function(te){switch(R){case 1:case 2:case 3:var fe=3;break;default:fe=R}var se=R;R=fe;try{return te()}finally{R=se}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(te,fe){switch(te){case 1:case 2:case 3:case 4:case 5:break;default:te=3}var se=R;R=te;try{return fe()}finally{R=se}},r.unstable_scheduleCallback=function(te,fe,se){var V=r.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?V+se:V):se=V,te){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=se+q,te={id:w++,callback:fe,priorityLevel:te,startTime:se,expirationTime:q,sortIndex:-1},se>V?(te.sortIndex=se,e(_,te),t(g)===null&&te===t(_)&&($?(ae(A),A=-1):$=!0,qe(pe,se-V))):(te.sortIndex=q,e(g,te),W||z||(W=!0,vt(Ce))),te},r.unstable_shouldYield=b,r.unstable_wrapCallback=function(te){var fe=R;return function(){var se=R;R=fe;try{return te.apply(this,arguments)}finally{R=se}}}})(td)),td}var ng;function t0(){return ng||(ng=1,ed.exports=e0()),ed.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wu=new Jd("@firebase/auth");function WT(r,...e){Wu.logLevel<=be.WARN&&Wu.warn(`Auth (${xo}): ${r}`,...e)}function Du(r,...e){Wu.logLevel<=be.ERROR&&Wu.error(`Auth (${xo}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ad(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.href)||""}function qT(){return yg()==="http:"||yg()==="https:"}function yg(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GT(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(qT()||I0()||"connection"in navigator)?navigator.onLine:!0}function KT(){if(typeof navigator>"u")return null;const r=navigator;return r.languages&&r.languages[0]||r.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ZT(r,e){return Po(r,"POST","/v1/accounts:delete",e)}async function qu(r,e){return Po(r,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qI(r,e){return e?xr(e):(Ee(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ko="12.10.0";function WS(r){ko=r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pt(r,e){const t={typeString:r};return e&&(t.value=e),t}function sl(r,e){if(!q_(r))throw new de(Y.INVALID_ARGUMENT,"JSON must be an object");let t;for(const s in e)if(e[s]){const o=e[s].typeString,u="value"in e[s]?{value:e[s].value}:void 0;if(!(s in r)){t=`JSON missing required field: '${s}'`;break}const h=r[s];if(o&&typeof h!==o){t=`JSON field '${s}' must be a ${o}.`;break}if(u!==void 0&&h!==u.value){t=`Expected '${s}' field to equal '${u.value}'`;break}}if(t)throw new de(Y.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qa=-1;function i1(r,e){const t=r.toTimestamp().seconds,s=r.toTimestamp().nanoseconds+1,o=we.fromTimestamp(s===1e9?new Je(t+1,0):new Je(t,s));return new Ri(o,ye.empty(),e)}function s1(r){return new Ri(r.readTime,r.key,qa)}class Ri{constructor(e,t,s){this.readTime=e,this.documentKey=t,this.largestBatchId=s}static min(){return new Ri(we.min(),ye.empty(),qa)}static max(){return new Ri(we.max(),ye.empty(),qa)}}function o1(r,e){let t=r.readTime.compareTo(e.readTime);return t!==0?t:(t=ye.comparator(r.documentKey,e.documentKey),t!==0?t:De(r.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WR{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):Or("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yC(r){r=Wa(r,At);const e=Wa(r.firestore,Lf),t=nE(e);return YR(t,r._key).then((s=>vC(e,r,s)))}function hE(r,e,t){r=Wa(r,At);const s=Wa(r.firestore,Lf),o=mC(r.converter,e),u=aC(s);return _C(s,[lC(u,"setDoc",r._key,o,r.converter!==null,t).toMutation(r._key,kr.none())])}function _C(r,e){const t=nE(r);return JR(t,e)}function vC(r,e,t){const s=t.docs.get(e._key),o=new fC(r);return new us(r,o,e._key,s,new Oa(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){WS(xo),wo(new hs("firestore",((s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new Lf(new KS(s.getProvider("auth-internal")),new JS(h,s.getProvider("app-check-internal")),m1(h,o),h);return u={useFetchStreams:t,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),wi(Cy,xy,e),wi(Cy,xy,"esm2020")})();const EC=["VITE_FIREBASE_API_KEY","VITE_FIREBASE_AUTH_DOMAIN","VITE_FIREBASE_PROJECT_ID","VITE_FIREBASE_STORAGE_BUCKET","VITE_FIREBASE_MESSAGING_SENDER_ID","VITE_FIREBASE_APP_ID"];function wC(r){return EC.filter(e=>!r[e])}function TC(r){const e=wC(r);if(e.length>0)throw new Error(`Missing required Firebase environment variables: ${e.join(", ")}. Ensure variables are set in .env.local (local dev) or GitHub Secrets (CI/CD).`)}const IC={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_FIREBASE_API_KEY:"AIzaSyD7PTbHJQehQB9nJvLU44gUyCizbQHasX4",VITE_FIREBASE_APP_ID:"1:662195056281:web:9a116d842188f7e7599208",VITE_FIREBASE_AUTH_DOMAIN:"math-trainer-1a632.firebaseapp.com",VITE_FIREBASE_MESSAGING_SENDER_ID:"662195056281",VITE_FIREBASE_PROJECT_ID:"math-trainer-1a632",VITE_FIREBASE_STORAGE_BUCKET:"math-trainer-1a632.firebasestorage.app"};TC(IC);const SC={apiKey:"AIzaSyD7PTbHJQehQB9nJvLU44gUyCizbQHasX4",authDomain:"math-trainer-1a632.firebaseapp.com",projectId:"math-trainer-1a632",storageBucket:"math-trainer-1a632.firebasestorage.app",messagingSenderId:"662195056281",appId:"1:662195056281:web:9a116d842188f7e7599208"};let pd,lc,dE;try{pd=t_(SC),lc=zS(pd),dE=nC(pd)}catch(r){throw new Error(`Firebase initialization failed: ${r.message}. Check that your Firebase configuration values are correct.`)}function AC(){const[r,e]=Q.useState(null),[t,s]=Q.useState(!0),[o,u]=Q.useState(null),h=Q.useCallback(async()=>{try{u(null),await R_(lc)}catch(m){console.error("Anonymous sign-in failed:",m.message),u(m)}},[]);return Q.useEffect(()=>{const m=kI(lc,g=>{g?(e(g),s(!1),console.log("User authenticated with ID:",g.uid)):(e(null),h())},g=>{console.error("Auth state change error:",g.message),u(g),s(!1)});return()=>m()},[h]),{user:r,loading:t,error:o}}const Pr={score:0,streak:0,currentStreak:0,totalProblems:0,correctAnswers:0,lastPlayed:null};function zf(r){return tC(dE,"users",r,"progress","gameData")}async function Py(r,e){if(!r)return console.error("saveProgress: userId is required"),!1;try{const t=zf(r);return await hE(t,{...e,lastPlayed:uE()}),console.log("Progress saved successfully for user:",r.substring(0,8)),!0}catch(t){throw console.error("Failed to save progress:",t.message),t}}async function RC(r){var e;if(!r)return console.error("loadProgress: userId is required"),Pr;try{const t=zf(r),s=await yC(t);if(s.exists()){const o=s.data();return console.log("Progress loaded for user:",r.substring(0,8)),{...Pr,...o,lastPlayed:((e=o.lastPlayed)==null?void 0:e.toDate())||null}}else return console.log("No progress found for user, returning defaults:",r.substring(0,8)),Pr}catch(t){return console.error("Failed to load progress:",t.message),Pr}}async function CC(r){if(!r)return console.error("resetProgress: userId is required"),!1;try{const e=zf(r);return await hE(e,{...Pr,lastPlayed:uE()}),console.log("Progress reset for user:",r.substring(0,8)),!0}catch(e){throw console.error("Failed to reset progress:",e.message),e}}const xC=2e3;function PC(r){const[e,t]=Q.useState(Pr),[s,o]=Q.useState(!0),[u,h]=Q.useState(!1),[m,g]=Q.useState(null),_=Q.useRef(!1),w=Q.useRef(null),T=Q.useRef(!0);Q.useEffect(()=>{if(!r){o(!1);return}let B=!1;async function ae(){try{o(!0),g(null);const ue=await RC(r);!B&&T.current&&(t(ue),_.current=!0)}catch(ue){!B&&T.current&&(console.error("useGameProgress: Failed to load progress",ue),g(ue),t(Pr),_.current=!0)}finally{!B&&T.current&&o(!1)}}return ae(),()=>{B=!0}},[r]),Q.useEffect(()=>(T.current=!0,()=>{T.current=!1,w.current&&clearTimeout(w.current)}),[]);const R=Q.useCallback(B=>{!r||!_.current||(w.current&&clearTimeout(w.current),w.current=setTimeout(async()=>{if(T.current)try{h(!0),await Py(r,B),T.current&&g(null)}catch(ae){console.error("useGameProgress: Failed to save progress",ae),T.current&&g(ae)}finally{T.current&&h(!1)}},xC))},[r]),z=Q.useCallback(B=>{t(ae=>{const ue={...ae,...B};return R(ue),ue})},[R]),W=Q.useCallback(async()=>{if(!r)return t(Pr),!0;try{return h(!0),g(null),await CC(r),T.current&&t(Pr),!0}catch(B){return console.error("useGameProgress: Failed to reset progress",B),T.current&&g(B),!1}finally{T.current&&h(!1)}},[r]),$=Q.useCallback(async()=>{if(!r||!_.current)return!1;w.current&&clearTimeout(w.current);try{return h(!0),await Py(r,e),T.current&&g(null),!0}catch(B){return console.error("useGameProgress: Failed to force save",B),T.current&&g(B),!1}finally{T.current&&h(!1)}},[r,e]);return{progress:e,updateProgress:z,resetProgress:W,forceSave:$,loading:s,saving:u,error:m}}const md=[{id:1,name:"First Steps",operators:["+"],minNumber:1,maxNumber:5,ageTarget:"5-6"},{id:2,name:"Addition Hero",operators:["+"],minNumber:1,maxNumber:10,ageTarget:"6"},{id:3,name:"Minus Magic",operators:["-"],minNumber:1,maxNumber:10,ageTarget:"6-7"},{id:4,name:"Mixed Warrior",operators:["+","-"],minNumber:1,maxNumber:10,ageTarget:"7"},{id:5,name:"Cross the 10",operators:["+"],minNumber:1,maxNumber:20,ageTarget:"7"},{id:6,name:"Subtract 20",operators:["-"],minNumber:1,maxNumber:20,ageTarget:"7-8"},{id:7,name:"Mixed 20",operators:["+","-"],minNumber:1,maxNumber:20,ageTarget:"8"},{id:8,name:"Tens Master",operators:["+","-"],minNumber:10,maxNumber:100,ageTarget:"8-9",multiplesOf:10},{id:9,name:"Century Runner",operators:["+","-"],minNumber:1,maxNumber:100,ageTarget:"9"},{id:10,name:"Speed of 2s",operators:["*"],minNumber:2,maxNumber:10,ageTarget:"9-10",multipliers:[2,5,10]},{id:11,name:"Times Tables",operators:["*"],minNumber:2,maxNumber:10,ageTarget:"10-11",multipliers:[3,4,6,7,8,9]},{id:12,name:"Division Quest",operators:["/"],minNumber:2,maxNumber:10,ageTarget:"11-12",divisors:[2,5,10]},{id:13,name:"Math Champion",operators:["+","-","*","/"],minNumber:1,maxNumber:100,ageTarget:"12-13"}];function Hd(r){if(r<1||r>md.length)throw new Error(`Invalid level: ${r}. Must be 1-${md.length}`);return md[r-1]}const Wd={NUM_OPTIONS:4,WRONG_ANSWER_RANGE:3},kC=Hd(2);function Xn(r,e){return Math.floor(Math.random()*(e-r+1))+r}function bu(r,e,t){const s=Math.ceil(r/t)*t,o=[];for(let u=s;u<=e;u+=t)o.push(u);return o[Xn(0,o.length-1)]}function fE(r){const e=[...r];for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function NC(r,e,t){t===void 0&&(t=r+20);const s=new Set,o=0,u=[];for(let g=-3;g<=Wd.WRONG_ANSWER_RANGE;g++){if(g===0)continue;const _=r+g;_>=o&&_<=t&&u.push(_)}const h=fE(u);for(const g of h){if(s.size>=e)break;s.add(g)}let m=Wd.WRONG_ANSWER_RANGE+1;for(;s.size<e;){const g=r+m,_=r-m;if(g<=t&&!s.has(g)&&s.add(g),s.size<e&&_>=o&&!s.has(_)&&s.add(_),m++,m>t)break}return Array.from(s).slice(0,e)}function ky(r=kC){const{operators:e,minNumber:t,maxNumber:s,multiplesOf:o,multipliers:u,divisors:h}=r,m=e[Xn(0,e.length-1)];let g,_,w,T;if(m==="+")g=o?bu(t,s,o):Xn(t,s),_=o?bu(t,s,o):Xn(t,s),w=g+_,T=s*2;else if(m==="-")g=o?bu(t,s,o):Xn(t,s),_=o?bu(t,g,o):Xn(t,g),g<_&&([g,_]=[_,g]),w=g-_,T=s;else if(m==="*"){const W=u||[2,3,4,5,6,7,8,9,10];g=W[Xn(0,W.length-1)],_=Xn(1,10),w=g*_,T=Math.max(...W)*10}else{const W=h||[2,3,4,5];_=W[Xn(0,W.length-1)];const $=Xn(1,10);g=_*$,w=$,T=Math.max(...W)*10}const R=NC(w,Wd.NUM_OPTIONS-1,T),z=fE([w,...R]);return{num1:g,num2:_,operator:m,correctAnswer:w,options:z}}function bC(r,e){return r===e}const DC=8,OC=-12,VC=3,LC=-8,MC=3e3,FC=1e4,UC=1.3,jC=1.6,zC=35,BC=20,$C=5,HC=85,WC=3,qC=50,pE="RECORD_ANSWER",mE="ACKNOWLEDGE_LEVEL_UP",gE="RESET";function qd(r){return Math.min(100,Math.max(0,Math.round(r)))}function GC(r){let e=DC;return r<MC&&(e+=VC),e}function KC(r){return r>FC?LC:OC}function QC(r,e){return e>=5?r*jC:e>=2?r*UC:r}function yE(r){return{score:qd(r??qC),streak:0,consecutiveWrong:0,shouldLevelUp:!1,lastDelta:0}}function YC(r,e){switch(e.type){case pE:{const{isCorrect:t,responseTimeMs:s}=e.payload;if(t){const m=r.streak+1,g=GC(s),_=QC(g,m),w=Math.round(_),T=qd(r.score+w),R=T>=HC&&m>=WC;return{score:T,streak:m,consecutiveWrong:0,shouldLevelUp:r.shouldLevelUp||R,lastDelta:w}}const o=KC(s),u=qd(r.score+o),h=r.consecutiveWrong+1;return{score:u,streak:0,consecutiveWrong:h,shouldLevelUp:r.shouldLevelUp,lastDelta:o}}case mE:return{...r,shouldLevelUp:!1};case gE:return yE(e.payload);default:return r}}function JC(r){const[e,t]=Q.useReducer(YC,r,yE),s=Q.useCallback((g,_)=>{t({type:pE,payload:{isCorrect:g,responseTimeMs:_}})},[]),o=Q.useCallback(()=>{t({type:mE})},[]),u=Q.useCallback(g=>{t({type:gE,payload:g})},[]),h=e.score<zC,m=e.score<BC&&e.consecutiveWrong>=$C;return{score:e.score,streak:e.streak,consecutiveWrong:e.consecutiveWrong,isStruggling:h,isCritical:m,shouldLevelUp:e.shouldLevelUp,lastDelta:e.lastDelta,recordAnswer:s,acknowledgeLevelUp:o,reset:u}}const XC=2e3,ZC=10,gd={isPlaying:!1,currentProblem:null,userAnswer:null,showFeedback:!1,isCorrect:!1,score:0,streak:0,bestStreak:0,totalProblems:0,correctAnswers:0};function ex({currentLevel:r=2,updateProgress:e,initialProgress:t}={}){const s=JC(),[o,u]=Q.useState(()=>({...gd,score:(t==null?void 0:t.score)??0,bestStreak:(t==null?void 0:t.streak)??0,totalProblems:(t==null?void 0:t.totalProblems)??0,correctAnswers:(t==null?void 0:t.correctAnswers)??0})),h=Q.useRef(null),m=Q.useRef(!0),g=Q.useRef(null);Q.useEffect(()=>(m.current=!0,()=>{m.current=!1,h.current&&clearTimeout(h.current)}),[]),Q.useEffect(()=>{t&&!o.isPlaying&&u($=>({...$,score:t.score??$.score,bestStreak:t.streak??$.bestStreak,totalProblems:t.totalProblems??$.totalProblems,correctAnswers:t.correctAnswers??$.correctAnswers}))},[t,o.isPlaying]);const _=Q.useCallback(()=>{const $=ky(Hd(r));s.reset(),g.current=Date.now(),u(B=>({...B,isPlaying:!0,currentProblem:$,userAnswer:null,showFeedback:!1,isCorrect:!1,score:0,streak:0}))},[r,s]),w=Q.useCallback(()=>{if(!m.current)return;const $=ky(Hd(r));g.current=Date.now(),u(B=>({...B,currentProblem:$,userAnswer:null,showFeedback:!1,isCorrect:!1}))},[r]),T=Q.useCallback($=>{const B=o;if(!B.isPlaying||!B.currentProblem||B.showFeedback)return;const ae=bC($,B.currentProblem.correctAnswer),ue=Date.now()-g.current;s.recordAnswer(ae,ue),u(ne=>{const pe=ae?ne.score+ZC:ne.score,Ce=ae?ne.streak+1:0,Te=Math.max(ne.bestStreak,Ce),k=ne.totalProblems+1,A=ae?ne.correctAnswers+1:ne.correctAnswers;return e&&e({score:pe,streak:Te,currentStreak:Ce,totalProblems:k,correctAnswers:A}),{...ne,userAnswer:$,showFeedback:!0,isCorrect:ae,score:pe,streak:Ce,bestStreak:Te,totalProblems:k,correctAnswers:A}}),h.current&&clearTimeout(h.current),h.current=setTimeout(()=>{m.current&&w()},XC)},[o,e,w,s]),R=Q.useCallback(()=>{h.current&&clearTimeout(h.current),s.reset(),u($=>({...gd,score:$.score,bestStreak:$.bestStreak,totalProblems:$.totalProblems,correctAnswers:$.correctAnswers}))},[s]),z=Q.useCallback(()=>{h.current&&clearTimeout(h.current),s.reset(),u(gd)},[s]),W=Q.useCallback(()=>o.totalProblems===0?0:Math.round(o.correctAnswers/o.totalProblems*100),[o.totalProblems,o.correctAnswers]);return{gameState:o,currentProblem:o.currentProblem,userAnswer:o.userAnswer,score:o.score,streak:s.streak,bestStreak:o.bestStreak,isPlaying:o.isPlaying,showFeedback:o.showFeedback,isCorrect:o.isCorrect,totalProblems:o.totalProblems,correctAnswers:o.correctAnswers,confidenceScore:s.score,isStruggling:s.isStruggling,isCritical:s.isCritical,shouldLevelUp:s.shouldLevelUp,lastDelta:s.lastDelta,consecutiveWrong:s.consecutiveWrong,acknowledgeLevelUp:s.acknowledgeLevelUp,handleAnswer:T,startGame:_,nextProblem:w,resetGame:R,fullReset:z,accuracy:W()}}var yd={exports:{}},_d,Ny;function tx(){if(Ny)return _d;Ny=1;var r="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return _d=r,_d}var vd,by;function nx(){if(by)return vd;by=1;var r=tx();function e(){}function t(){}return t.resetWarningCache=e,vd=function(){function s(h,m,g,_,w,T){if(T!==r){var R=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw R.name="Invariant Violation",R}}s.isRequired=s;function o(){return s}var u={array:s,bigint:s,bool:s,func:s,number:s,object:s,string:s,symbol:s,any:s,arrayOf:o,element:s,elementType:s,instanceOf:o,node:s,objectOf:o,oneOf:o,oneOfType:o,shape:o,exact:o,checkPropTypes:t,resetWarningCache:e};return u.PropTypes=u,u},vd}var Dy;function rx(){return Dy||(Dy=1,yd.exports=nx()()),yd.exports}var ix=rx();const ee=Qd(ix);function _E({num1:r,num2:e,operator:t}){return C.jsx("section",{className:"bg-sonic-blue rounded-2xl shadow-lg p-6 md:p-8 w-full max-w-md mx-auto","aria-label":"Math Problem",children:C.jsx("div",{className:"text-center",children:C.jsxs("p",{className:`text-4xl md:text-6xl font-game text-white tracking-wide
                     drop-shadow-md select-none`,"aria-live":"polite","aria-atomic":"true",children:[C.jsx("span",{className:"inline-block mx-2",children:r}),C.jsx("span",{className:"inline-block mx-2 text-sonic-gold",children:t}),C.jsx("span",{className:"inline-block mx-2",children:e}),C.jsx("span",{className:"inline-block mx-2",children:"="}),C.jsx("span",{className:"inline-block mx-2 text-sonic-gold animate-pulse",children:"?"})]})})})}_E.propTypes={num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.string.isRequired};function vE({options:r,onAnswer:e,disabled:t=!1}){const s=u=>{t||e(u)},o=(u,h)=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),s(h))};return C.jsx("div",{className:"grid grid-cols-2 gap-3 md:gap-4 w-full max-w-md mx-auto mt-6",role:"group","aria-label":"Answer Options",children:r.map((u,h)=>C.jsx("button",{onClick:()=>s(u),onKeyDown:m=>o(m,u),disabled:t,className:`
          ...
          `,"aria-label":`Answer: ${u}`,children:u},`answer-${h}-${u}`))})}vE.propTypes={options:ee.arrayOf(ee.number).isRequired,onAnswer:ee.func.isRequired,disabled:ee.bool};function EE({score:r,streak:e}){const s=e>=10?{emoji:"🔥",label:"On Fire!"}:e>=5?{emoji:"⚡",label:"Lightning!"}:e>=3?{emoji:"🦔",label:"Speedy!"}:{emoji:"⭐",label:"Keep going!"};return C.jsxs("div",{className:`flex justify-between items-center w-full max-w-md mx-auto
                 bg-black/30 rounded-xl p-4 md:p-5`,role:"status","aria-label":`Score: ${r}, Streak: ${e}`,children:[C.jsxs("div",{className:"text-center flex-1",children:[C.jsx("p",{className:"text-sm md:text-base text-white/70 font-game uppercase tracking-wide",children:"Score"}),C.jsx("p",{className:`text-3xl md:text-4xl font-game text-sonic-gold drop-shadow-md
                     transition-all duration-300`,"aria-live":"polite",children:r})]}),C.jsx("div",{className:"w-px h-12 bg-white/20 mx-4","aria-hidden":"true"}),C.jsxs("div",{className:"text-center flex-1",children:[C.jsx("p",{className:"text-sm md:text-base text-white/70 font-game uppercase tracking-wide",children:"Streak"}),C.jsxs("div",{className:"flex items-center justify-center gap-2",children:[C.jsx("p",{className:`text-3xl md:text-4xl font-game text-sonic-gold drop-shadow-md
                       ...
                       ${e>0?"animate-bounce":""}`,"aria-live":"polite",children:e}),e>0&&C.jsx("span",{className:"text-2xl md:text-3xl transition-transform duration-300","aria-label":s.label,role:"img",children:s.emoji})]})]})]})}EE.propTypes={score:ee.number.isRequired,streak:ee.number.isRequired};const sx=[{text:"Sonic Speed!",emoji:"🦔💨"},{text:"Amazing!",emoji:"⭐"},{text:"Perfect!",emoji:"🎯"},{text:"Great Job!",emoji:"🎉"},{text:"You're on Fire!",emoji:"🔥"},{text:"Super Star!",emoji:"🌟"},{text:"Awesome!",emoji:"✨"},{text:"Incredible!",emoji:"💫"}],ox=[{text:"Try Again!",emoji:"💪"},{text:"Almost There!",emoji:"🎈"},{text:"Keep Going!",emoji:"🚀"},{text:"You've Got This!",emoji:"👍"},{text:"So Close!",emoji:"🌈"},{text:"One More Try!",emoji:"🎮"}],Oy=200,Vy=1500,ax=200;function wE({isCorrect:r,onComplete:e=null}){const[t,s]=Q.useState(!1),[o,u]=Q.useState(!1),[h,m]=Q.useState({text:"",emoji:""}),g=Q.useCallback(()=>{const _=r?sx:ox,w=Math.floor(Math.random()*_.length);return _[w]},[r]);return Q.useEffect(()=>{m(g()),s(!0),u(!1);const _=setTimeout(()=>{u(!0)},Oy+Vy),w=setTimeout(()=>{s(!1),e&&e()},Oy+Vy+ax);return()=>{clearTimeout(_),clearTimeout(w)}},[r,e,g]),t?C.jsx("div",{className:`
      ...
      `,"aria-live":"polite",role:"status",children:C.jsxs("div",{className:`
        ...
        `,children:[C.jsx("div",{className:`text-6xl md:text-7xl mb-4 ${r?"animate-bounce-custom":"animate-shake"}`,children:r?"✅":"🔄"}),C.jsx("h2",{className:`
          ...
          `,children:h.text}),C.jsx("span",{className:"text-4xl md:text-5xl mt-3 animate-bounce",children:h.emoji}),r&&C.jsxs("div",{className:"absolute inset-0 pointer-events-none overflow-hidden rounded-3xl",children:[C.jsx("div",{className:"sparkle sparkle-1",children:"✨"}),C.jsx("div",{className:"sparkle sparkle-2",children:"⭐"}),C.jsx("div",{className:"sparkle sparkle-3",children:"💫"}),C.jsx("div",{className:"sparkle sparkle-4",children:"🌟"}),C.jsx("div",{className:"sparkle sparkle-5",children:"✨"}),C.jsx("div",{className:"sparkle sparkle-6",children:"⭐"})]})]})}):null}wE.propTypes={isCorrect:ee.bool.isRequired,onComplete:ee.func};const lx=5;function TE({color:r,faded:e,index:t,testId:s}){return C.jsx("span",{className:`
        inline-block rounded-full
        w-6 h-6 md:w-7 md:h-7
        ${r}
        ${e?"opacity-50":""}
        animate-aid-enter motion-reduce:animate-none
      `,style:{animationDelay:`${t*60}ms`,animationFillMode:"both"},"aria-hidden":"true","data-testid":s})}TE.propTypes={color:ee.string.isRequired,faded:ee.bool.isRequired,index:ee.number.isRequired,testId:ee.string.isRequired};function Va({count:r,color:e,faded:t,startIndex:s,testIdPrefix:o}){return C.jsx("div",{className:"grid gap-2",style:{gridTemplateColumns:`repeat(${lx}, auto)`},"data-testid":`${o}-group`,children:Array.from({length:r}).map((u,h)=>C.jsx(TE,{color:e,faded:t,index:s+h,testId:`${o}-dot-${h}`},h))})}Va.propTypes={count:ee.number.isRequired,color:ee.string.isRequired,faded:ee.bool.isRequired,startIndex:ee.number.isRequired,testIdPrefix:ee.string.isRequired};function IE({num1:r,num2:e,operator:t}){if(t==="+")return C.jsxs("div",{className:"flex flex-wrap items-center gap-3",role:"img","aria-label":`${r} blue dots plus ${e} gold dots`,"data-testid":"dot-counter",children:[C.jsx(Va,{count:r,color:"bg-sonic-blue",faded:!1,startIndex:0,testIdPrefix:"num1"}),C.jsx("span",{className:"text-2xl md:text-3xl font-game text-white drop-shadow-md select-none","aria-hidden":"true","data-testid":"operator-label",children:"+"}),C.jsx(Va,{count:e,color:"bg-sonic-gold",faded:!1,startIndex:r,testIdPrefix:"num2"})]});const s=r-e;return C.jsxs("div",{className:"flex flex-wrap items-center gap-3",role:"img","aria-label":`${r} blue dots minus ${e} faded dots`,"data-testid":"dot-counter",children:[C.jsx(Va,{count:s,color:"bg-sonic-blue",faded:!1,startIndex:0,testIdPrefix:"solid"}),C.jsx("span",{className:"text-2xl md:text-3xl font-game text-white drop-shadow-md select-none","aria-hidden":"true","data-testid":"operator-label",children:"-"}),C.jsx(Va,{count:e,color:"bg-sonic-blue",faded:!0,startIndex:s,testIdPrefix:"faded"})]})}IE.propTypes={num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.oneOf(["+","-"]).isRequired};const Ly=24,ux=120,sr=85,cx=8,hx=14,dx=6,SE=22,fx=100,My=60,px="#666666",Fy="#999999",AE="#0066cc",mx="#ffd700";function gx(r,e,t){const s=t==="+"?r+e:r-e;return Math.max(r,r+e,s,20)}function yx(r){return r%5===0}function gs(r,e,t){const s=t-2*Ly;return Ly+r/e*s}function _x(r,e){const t=(r+e)/2,s=sr-SE;return`M ${r} ${sr} Q ${t} ${s} ${e} ${sr}`}function vx(r,e,t){return`Number line showing ${r} ${t==="+"?"plus":"minus"} ${e}, answer hidden`}function RE({maxValue:r,viewBoxWidth:e}){const t=gs(0,r,e),s=gs(r,r,e);return C.jsx("line",{x1:t,y1:sr,x2:s,y2:sr,stroke:px,strokeWidth:2,"data-testid":"number-line-base"})}RE.propTypes={maxValue:ee.number.isRequired,viewBoxWidth:ee.number.isRequired};function CE({maxValue:r,viewBoxWidth:e}){const t=[];for(let s=0;s<=r;s++){const o=gs(s,r,e),u=yx(s),h=u?hx:cx;t.push(C.jsxs("g",{"data-testid":`tick-${s}`,children:[C.jsx("line",{x1:o,y1:sr-h/2,x2:o,y2:sr+h/2,stroke:Fy,strokeWidth:1}),u&&C.jsx("text",{x:o,y:sr+h/2+14,textAnchor:"middle",fontSize:"11",fill:Fy,fontFamily:"Comic Sans MS, cursive, sans-serif","data-testid":`tick-label-${s}`,children:s})]},s))}return C.jsx(C.Fragment,{children:t})}CE.propTypes={maxValue:ee.number.isRequired,viewBoxWidth:ee.number.isRequired};function xE({num1:r,maxValue:e,viewBoxWidth:t}){const s=gs(r,e,t);return C.jsx("circle",{cx:s,cy:sr,r:dx,fill:AE,"data-testid":"start-dot"})}xE.propTypes={num1:ee.number.isRequired,maxValue:ee.number.isRequired,viewBoxWidth:ee.number.isRequired};function PE({num1:r,num2:e,operator:t,maxValue:s,viewBoxWidth:o}){const u=t==="+"?1:-1,h=[];for(let m=0;m<e;m++){const g=r+m*u,_=g+u,w=gs(g,s,o),T=gs(_,s,o),R=_x(w,T);h.push(C.jsx("path",{d:R,fill:"none",stroke:AE,strokeWidth:2,strokeDasharray:My,strokeDashoffset:My,className:"animate-arc-draw motion-reduce:animate-none motion-reduce:[stroke-dashoffset:0]",style:{animationDelay:`${m*fx}ms`,animationFillMode:"forwards"},"data-testid":`arc-${m}`},m))}return C.jsx(C.Fragment,{children:h})}PE.propTypes={num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.oneOf(["+","-"]).isRequired,maxValue:ee.number.isRequired,viewBoxWidth:ee.number.isRequired};function kE({num1:r,num2:e,operator:t,maxValue:s,viewBoxWidth:o}){const u=t==="+"?r+e:r-e,h=gs(u,s,o);return C.jsx("text",{x:h,y:sr-SE-8,textAnchor:"middle",fontSize:"20",fontWeight:"bold",fill:mx,fontFamily:"Comic Sans MS, cursive, sans-serif","data-testid":"answer-marker",children:"?"})}kE.propTypes={num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.oneOf(["+","-"]).isRequired,maxValue:ee.number.isRequired,viewBoxWidth:ee.number.isRequired};const uo=400;function NE({num1:r,num2:e,operator:t}){const s=gx(r,e,t),o=vx(r,e,t);return C.jsxs("svg",{viewBox:`0 0 ${uo} ${ux}`,className:"w-full max-h-[120px]",role:"img","aria-label":o,"data-testid":"number-line",children:[C.jsx(RE,{maxValue:s,viewBoxWidth:uo}),C.jsx(CE,{maxValue:s,viewBoxWidth:uo}),C.jsx(xE,{num1:r,maxValue:s,viewBoxWidth:uo}),C.jsx(PE,{num1:r,num2:e,operator:t,maxValue:s,viewBoxWidth:uo}),C.jsx(kE,{num1:r,num2:e,operator:t,maxValue:s,viewBoxWidth:uo})]})}NE.propTypes={num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.oneOf(["+","-"]).isRequired};const Uy=4,Ex=7;function wx(r){return r>=1&&r<=Uy?IE:r>=Uy+1&&r<=Ex?NE:null}function bE({isStruggling:r,currentLevel:e,num1:t,num2:s,operator:o}){const[u,h]=Q.useState(!1);if(!r||u)return null;const m=wx(e);return m?C.jsxs("div",{className:`
        max-h-[120px] overflow-hidden
        bg-black/20 backdrop-blur-sm rounded-2xl p-3
        animate-aid-enter motion-reduce:animate-none
      `,"data-testid":"learning-aid-container",children:[C.jsx(m,{num1:t,num2:s,operator:o}),C.jsx("button",{type:"button",onClick:()=>h(!0),className:`
        ...
        `,"aria-label":"Dismiss learning aid","data-testid":"dismiss-aid-button",children:"I got it!"})]}):null}bE.propTypes={isStruggling:ee.bool.isRequired,currentLevel:ee.number.isRequired,num1:ee.number.isRequired,num2:ee.number.isRequired,operator:ee.oneOf(["+","-","*","/"]).isRequired};function DE({onGameEnd:r,updateProgress:e=null,initialProgress:t=null}){const{currentProblem:s,score:o,streak:u,bestStreak:h,showFeedback:m,isCorrect:g,handleAnswer:_,startGame:w,isPlaying:T,totalProblems:R,correctAnswers:z,accuracy:W,isStruggling:$}=ex({updateProgress:e,initialProgress:t});if(!T)return w(),null;if(!s)return C.jsx("div",{className:"min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900 flex items-center justify-center",children:C.jsx("p",{className:"text-white font-game text-2xl",children:"Loading..."})});const B=()=>{r&&r({score:o,streak:h,totalProblems:R,correctAnswers:z,accuracy:W})};return C.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900 flex flex-col p-4 md:p-6 relative",children:[C.jsxs("header",{className:"flex justify-between items-start gap-4 mb-6 md:mb-8",children:[C.jsx("div",{className:"flex-1",children:C.jsx(EE,{score:o,streak:u})}),C.jsx("button",{onClick:B,className:`
          ...
          `,"aria-label":"Exit game and return to start screen",children:"Exit"})]}),C.jsxs("main",{className:"flex-1 flex flex-col items-center justify-center gap-6 md:gap-8",children:[C.jsx("div",{className:"w-full transform transition-all duration-300 ease-out",children:C.jsx(_E,{num1:s.num1,num2:s.num2,operator:s.operator})}),C.jsx(bE,{isStruggling:$,currentLevel:2,num1:s.num1,num2:s.num2,operator:s.operator},R),C.jsx("div",{className:"w-full",children:C.jsx(vE,{options:s.options,onAnswer:_,disabled:m})})]}),C.jsx("footer",{className:"h-8 md:h-12","aria-hidden":"true"}),m&&C.jsx(wE,{isCorrect:g})]})}DE.propTypes={onGameEnd:ee.func.isRequired,updateProgress:ee.func,initialProgress:ee.shape({score:ee.number,streak:ee.number,totalProblems:ee.number,correctAnswers:ee.number})};function OE({onStart:r,progress:e=null}){const t=e&&(e.score>0||e.streak>0);return C.jsxs("div",{className:`min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900
          ...
          `,"aria-label":"Start the math game",children:"Start Game!"}),C.jsxs("p",{className:"text-lg md:text-xl font-game text-white/70 mt-8",children:[C.jsx("span",{role:"img","aria-label":"star",children:"⭐"})," Tap the correct answer to score points!"," ",C.jsx("span",{role:"img","aria-label":"star",children:"⭐"})]})]}),C.jsx("div",{className:"absolute bottom-4 text-center text-white/40 font-game text-sm",children:"Math is fun!"})]})}OE.propTypes={onStart:ee.func.isRequired,progress:ee.shape({score:ee.number,streak:ee.number,totalProblems:ee.number,correctAnswers:ee.number})};function VE({sessionStats:r,onPlayAgain:e,onExit:t}){const{score:s=0,streak:o=0,totalProblems:u=0,correctAnswers:h=0,accuracy:m=0}=r||{},_=m>=80?{text:"Sonic Speed! Amazing!",emoji:"🦔💨",color:"text-green-400"}:m>=50?{text:"Great effort! Keep practicing!",emoji:"⭐",color:"text-sonic-gold"}:{text:"You're learning! Try again!",emoji:"💪",color:"text-orange-400"};return C.jsxs("div",{className:`min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900
            ...
            `,"aria-label":"Go back to start screen",children:"Back to Start"})]}),C.jsxs("p",{className:"text-lg font-game text-white/60 mt-8",children:["Keep practicing to become a Math Master!"," ",C.jsx("span",{role:"img","aria-label":"trophy",children:"🏆"})]})]})]})}VE.propTypes={sessionStats:ee.shape({score:ee.number,streak:ee.number,totalProblems:ee.number,correctAnswers:ee.number,accuracy:ee.number}).isRequired,onPlayAgain:ee.func.isRequired,onExit:ee.func.isRequired};const LE=Q.createContext(null);function ME(){const r=Q.useContext(LE);if(r===null)throw new Error("useProfile must be used within a <ProfileProvider>");return r}const FE="math-trainer-profiles",Gd=4,as=12,Tx=4,Rr=["sonic","spiderman"];function Cc(){try{const r=localStorage.getItem(FE);if(r===null)return[];const e=JSON.parse(r);return Array.isArray(e)?e:(console.warn("[profiles] Corrupt data in localStorage — expected array, got",typeof e),[])}catch(r){return console.warn("[profiles] Failed to parse localStorage data:",r.message),[]}}function Bf(r){localStorage.setItem(FE,JSON.stringify(r))}function Ix(r){const e=new Uint8Array(r);let t="";for(let s=0;s<e.length;s++)t+=e[s].toString(16).padStart(2,"0");return t}function jy(){return Cc()}function Sx({nickname:r,theme:e,pinHash:t,firebaseUid:s=null,currentLevel:o=1}){const u=Cc();if(u.length>=Gd)throw new Error(`Maximum of ${Gd} profiles reached`);if(typeof r!="string"||r.trim().length===0)throw new Error("Nickname is required");const h=r.trim();if([...h].length>as)throw new Error(`Nickname must be ${as} characters or fewer`);if(!Rr.includes(e))throw new Error(`Theme must be one of: ${Rr.join(", ")}`);if(typeof t!="string"||!/^[0-9a-f]{64}$/.test(t))throw new Error("pinHash must be a 64-character hex string");const m=new Date().toISOString(),g={id:crypto.randomUUID(),nickname:h,theme:e,pinHash:t,firebaseUid:s,currentLevel:o,createdAt:m,lastActiveAt:m};return u.push(g),Bf(u),g}function zy(r,e){const t=Cc(),s=t.findIndex(m=>m.id===r);if(s===-1)throw new Error(`Profile not found: ${r}`);const{id:o,createdAt:u,...h}=e;return t[s]={...t[s],...h,lastActiveAt:new Date().toISOString()},Bf(t),t[s]}function Ax(r){const e=Cc(),t=e.filter(s=>s.id!==r);return t.length===e.length?!1:(Bf(t),!0)}async function Kd(r){if(typeof r!="string"||!/^\d{4}$/.test(r))throw new Error(`PIN must be exactly ${Tx} digits`);const t=new TextEncoder().encode(r),s=await crypto.subtle.digest("SHA-256",t);return Ix(s)}async function Rx(r,e){return await Kd(r)===e}const ss="math-trainer-active-profile",Cx=3,xx=30,It=Object.freeze({SET_PROFILES:"SET_PROFILES",SET_ACTIVE:"SET_ACTIVE",CLEAR_ACTIVE:"CLEAR_ACTIVE",ADD_PROFILE:"ADD_PROFILE",UPDATE_PROFILE:"UPDATE_PROFILE",DELETE_PROFILE:"DELETE_PROFILE",SET_LOADING:"SET_LOADING",SET_ERROR:"SET_ERROR"}),Px={profiles:[],activeProfile:null,isLoading:!0,error:null};function kx(r,e){var t,s;switch(e.type){case It.SET_PROFILES:return{...r,profiles:e.payload,isLoading:!1};case It.SET_ACTIVE:return{...r,activeProfile:e.payload,error:null};case It.CLEAR_ACTIVE:return{...r,activeProfile:null};case It.ADD_PROFILE:return{...r,profiles:[...r.profiles,e.payload]};case It.UPDATE_PROFILE:return{...r,profiles:r.profiles.map(o=>o.id===e.payload.id?e.payload:o),activeProfile:((t=r.activeProfile)==null?void 0:t.id)===e.payload.id?e.payload:r.activeProfile};case It.DELETE_PROFILE:{const o=r.profiles.filter(u=>u.id!==e.payload);return{...r,profiles:o,activeProfile:((s=r.activeProfile)==null?void 0:s.id)===e.payload?null:r.activeProfile}}case It.SET_LOADING:return{...r,isLoading:e.payload};case It.SET_ERROR:return{...r,error:e.payload};default:return r}}const ka=4;function uc({profileName:r,onSubmit:e,onCancel:t,isVerifying:s=!1,error:o=null,attempts:u=0,maxAttempts:h=3,cooldownSeconds:m=30}){const[g,_]=Q.useState(""),[w,T]=Q.useState(!1),[R,z]=Q.useState(0),W=Q.useRef(null),$=R>0;Q.useEffect(()=>{u>=h&&R===0&&z(m)},[u,h,m,R]),Q.useEffect(()=>{if(!(R<=0))return W.current=setInterval(()=>{z(ne=>ne<=1?(clearInterval(W.current),0):ne-1)},1e3),()=>clearInterval(W.current)},[R]),Q.useEffect(()=>{if(o){T(!0),_("");const ne=setTimeout(()=>T(!1),500);return()=>clearTimeout(ne)}},[o]);const B=Q.useCallback(ne=>{s||$||_(pe=>{if(pe.length>=ka)return pe;const Ce=pe+ne;return Ce.length===ka&&setTimeout(()=>e(Ce),0),Ce})},[s,$,e]),ae=Q.useCallback(()=>{s||$||_(ne=>ne.slice(0,-1))},[s,$]);Q.useEffect(()=>{function ne(pe){pe.key>="0"&&pe.key<="9"?B(pe.key):pe.key==="Backspace"?ae():pe.key==="Escape"&&t()}return window.addEventListener("keydown",ne),()=>window.removeEventListener("keydown",ne)},[B,ae,t]);const ue=[["1","2","3"],["4","5","6"],["7","8","9"],["backspace","0","cancel"]];return C.jsx("div",{className:`fixed inset-0 z-50 bg-black/40 backdrop-blur-sm
              ...
              `,"aria-hidden":"true"},pe))}),o&&C.jsx("p",{className:"text-red-300 text-sm font-game text-center mb-3",role:"alert",children:o}),$&&C.jsxs("p",{className:"text-red-300 text-sm font-game text-center mb-3",role:"alert",children:["Too many tries! Wait ",R,"s"]}),C.jsx("div",{className:"grid grid-cols-3 gap-2 max-w-[280px] mx-auto",children:ue.flat().map(ne=>ne==="backspace"?C.jsx("button",{onClick:ae,disabled:s||$||g.length===0,className:`aspect-square rounded-xl bg-white/10 hover:bg-white/20
                           ...
                           transition-all duration-150
                           active:scale-90 disabled:opacity-30
                           focus:outline-none focus:ring-2 focus:ring-sonic-gold`,"aria-label":`Digit ${ne}`,children:ne},ne))}),s&&C.jsx("p",{className:"text-white/70 text-sm font-game text-center mt-4 animate-pulse",children:"Checking..."})]})})}uc.propTypes={profileName:ee.string.isRequired,onSubmit:ee.func.isRequired,onCancel:ee.func.isRequired,isVerifying:ee.bool,error:ee.string,attempts:ee.number,maxAttempts:ee.number,cooldownSeconds:ee.number};const Nx={sonic:"🦔",spiderman:"🕷"},bx={sonic:"border-sonic-blue",spiderman:"border-sonic-red"};function UE({onCreateProfile:r,onProfileActivated:e}){const{profiles:t,selectProfile:s,maxProfiles:o}=ME(),[u,h]=Q.useState(null),[m,g]=Q.useState(!1),[_,w]=Q.useState(null),[T,R]=Q.useState(0),z=Q.useCallback(B=>{h(B),w(null),R(0)},[]),W=Q.useCallback(async B=>{if(u){g(!0),w(null);try{await s(u,B)?(h(null),e&&e()):(R(ue=>ue+1),w("Oops! Wrong PIN. Try again."),navigator.vibrate&&navigator.vibrate(100))}catch{w("Something went wrong. Try again.")}finally{g(!1)}}},[u,s,e]),$=Q.useCallback(()=>{h(null),w(null),R(0)},[]);return t.length===0?C.jsxs("div",{className:`min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900
            ...
            `,"aria-label":`Select ${B.nickname}, Level ${B.currentLevel}`,children:[C.jsx("span",{className:"text-4xl",role:"img","aria-hidden":"true",children:Nx[B.theme]||B.nickname.charAt(0).toUpperCase()}),C.jsx("span",{className:"text-lg font-game text-white truncate w-full text-center",dir:"auto",children:B.nickname}),C.jsxs("span",{className:"text-xs font-game text-sonic-gold bg-sonic-gold/20 px-2 py-0.5 rounded-full",children:["Level ",B.currentLevel]})]},B.id)),t.length<o&&C.jsxs("button",{onClick:r,className:`bg-transparent rounded-2xl p-4
                       ...
                       focus:outline-none focus:ring-2 focus:ring-sonic-gold
                       min-h-[140px]`,"aria-label":"Create a new hero profile",children:[C.jsx("span",{className:"text-4xl text-white/50",children:"+"}),C.jsx("span",{className:"text-sm font-game text-white/50",children:"Add Hero"})]})]}),u&&C.jsx(uc,{profileName:u.nickname,onSubmit:W,onCancel:$,isVerifying:m,error:_,attempts:T,maxAttempts:Cx,cooldownSeconds:xx})]})}UE.propTypes={onCreateProfile:ee.func.isRequired,onProfileActivated:ee.func};const kt=Object.freeze({SET_NICKNAME:"SET_NICKNAME",SET_THEME:"SET_THEME",SET_PIN_HASH:"SET_PIN_HASH",CONFIRM_MISMATCH:"CONFIRM_MISMATCH",SET_SUBMITTING:"SET_SUBMITTING",SET_ERROR:"SET_ERROR",GO_BACK:"GO_BACK",RESET:"RESET"}),jE={step:1,nickname:"",theme:null,pinHash:null,isSubmitting:!1,error:null};function Dx(r,e){switch(e.type){case kt.SET_NICKNAME:return{...r,nickname:e.payload,step:2,error:null};case kt.SET_THEME:return{...r,theme:e.payload,step:3,error:null};case kt.SET_PIN_HASH:return{...r,pinHash:e.payload,step:4,error:null};case kt.CONFIRM_MISMATCH:return{...r,error:"PINs do not match. Try again!"};case kt.SET_SUBMITTING:return{...r,isSubmitting:e.payload,error:null};case kt.SET_ERROR:return{...r,error:e.payload,isSubmitting:!1};case kt.GO_BACK:return r.step===2?{...r,step:1,error:null}:r.step===3?{...r,step:2,error:null}:r.step===4?{...r,step:3,pinHash:null,error:null}:r;case kt.RESET:return{...jE};default:return r}}const By=4,$y={sonic:"🦔",spiderman:"🕷"},Hy={sonic:"Sonic",spiderman:"Spiderman"},Ox={sonic:"shadow-blue-500/40",spiderman:"shadow-red-500/40"},Vx={sonic:"border-sonic-blue",spiderman:"border-sonic-red"};function zE({currentStep:r}){return C.jsx("div",{className:"flex justify-center gap-3 mb-6",role:"group","aria-label":"Profile creation progress",children:Array.from({length:By}).map((e,t)=>{const s=t+1,o=s===r,u=s<r;return C.jsx("div",{className:`
              w-3 h-3 rounded-full transition-all duration-300
              motion-reduce:transition-none
              ${u?"bg-sonic-gold":""}
              ${o?"bg-sonic-gold animate-pulse motion-reduce:animate-none":""}
              ${!u&&!o?"border-2 border-white/30 bg-transparent":""}
            `,"aria-current":o?"step":void 0,"aria-label":`Step ${s} of ${By}${o?", current":u?", completed":""}`},s)})})}zE.propTypes={currentStep:ee.number.isRequired};function BE({onComplete:r,onCancel:e}){const[t,s]=Q.useReducer(Dx,jE),o=Q.useRef(null),u=Q.useRef(null),h=Q.useRef(!0);Q.useEffect(()=>(h.current=!0,()=>{h.current=!1}),[]),Q.useEffect(()=>{t.step===1&&o.current&&o.current.focus()},[t.step]);const[m,g]=Q.useReducer((D,I)=>I,t.nickname);Q.useEffect(()=>{t.step===1&&g(t.nickname)},[t.step,t.nickname]);const[_,w]=Q.useReducer((D,I)=>I,t.theme);Q.useEffect(()=>{t.step===2&&w(t.theme)},[t.step,t.theme]);const T=[...m].length,R=as-T,z=m.trim().length>0&&T<=as,W=Q.useCallback(D=>{const I=D.target.value;[...I].length<=as&&g(I)},[]),$=Q.useCallback(()=>{const D=m.trim();D.length>0&&[...D].length<=as&&s({type:kt.SET_NICKNAME,payload:D})},[m]),B=Q.useCallback(D=>{D.key==="Enter"&&(D.preventDefault(),$())},[$]),ae=Q.useCallback(()=>{_&&Rr.includes(_)&&s({type:kt.SET_THEME,payload:_})},[_]),ue=Q.useCallback(D=>{if(D.key==="ArrowLeft"||D.key==="ArrowRight"){D.preventDefault();const I=Rr.indexOf(_),Pe=D.key==="ArrowRight"?(I+1)%Rr.length:(I-1+Rr.length)%Rr.length;w(Rr[Pe])}},[_]),ne=Q.useCallback(async D=>{try{const I=await Kd(D);h.current&&s({type:kt.SET_PIN_HASH,payload:I})}catch{h.current&&s({type:kt.SET_ERROR,payload:"Could not process PIN. Try again."})}},[]),pe=Q.useCallback(async D=>{var I;try{const Pe=await Kd(D);if(!h.current)return;if(Pe!==t.pinHash){s({type:kt.CONFIRM_MISMATCH});return}s({type:kt.SET_SUBMITTING,payload:!0});const rt=await R_(lc);if(!h.current)return;const vt=rt.user.uid,qe=Sx({nickname:t.nickname,theme:t.theme,pinHash:t.pinHash,firebaseUid:vt});if(!h.current)return;r(qe)}catch(Pe){if(!h.current)return;const rt=(I=Pe==null?void 0:Pe.message)!=null&&I.includes("Maximum")?Pe.message:"Could not create hero. Try again!";s({type:kt.SET_ERROR,payload:rt})}},[t.pinHash,t.nickname,t.theme,r]),Ce=Q.useCallback(()=>{s({type:kt.SET_ERROR,payload:null})},[]),Te=Q.useCallback(()=>{s({type:kt.GO_BACK})},[]);Q.useEffect(()=>{function D(I){I.key==="Escape"&&(t.step===1?e():t.isSubmitting||Te())}return window.addEventListener("keydown",D),()=>window.removeEventListener("keydown",D)},[t.step,t.isSubmitting,e,Te]);const k=()=>t.isSubmitting?null:t.step===1?C.jsx("button",{onClick:e,className:`text-white/70 font-game text-sm py-3 px-4 min-h-[44px]
              ...
              `,children:[C.jsx("span",{className:"text-6xl",role:"img","aria-hidden":"true",children:$y[D]}),C.jsx("span",{className:"text-lg font-game text-white",children:Hy[D]}),I&&C.jsx("span",{className:"absolute top-2 right-2 text-sonic-gold text-xl","aria-hidden":"true",children:"✔"})]},D)})}),C.jsx("button",{ref:u,onClick:ae,disabled:!_,className:`bg-gradient-to-r from-sonic-gold to-yellow-400
                  ...
                  flex flex-col items-center justify-center p-6`,role:"dialog","aria-label":"Create a new hero profile",children:[C.jsx(zE,{currentStep:t.step}),t.step===1&&A(),t.step===2&&x()]})}BE.propTypes={onComplete:ee.func.isRequired,onCancel:ee.func.isRequired};function Lx(){const{activeProfile:r,isLoading:e,clearActiveProfile:t,createAndActivate:s}=ME(),{user:o,loading:u,error:h}=AC(),{progress:m,updateProgress:g,forceSave:_,loading:w}=PC((r==null?void 0:r.firebaseUid)??(o==null?void 0:o.uid)),[T,R]=Q.useState("start"),[z,W]=Q.useState(null),[$,B]=Q.useState(!1),ae=e||u||w,ue=Q.useCallback(N=>{if(N){const b=N.accuracy??(N.totalProblems>0?Math.round(N.correctAnswers/N.totalProblems*100):0);W({score:N.score??0,streak:N.streak??0,totalProblems:N.totalProblems??0,correctAnswers:N.correctAnswers??0,accuracy:b}),R("result")}else R("start")},[]),ne=Q.useCallback(()=>{W(null),R("game")},[]),pe=Q.useCallback(()=>{W(null),R("game")},[]),Ce=Q.useCallback(()=>{_(),W(null),R("start")},[_]),Te=Q.useCallback(()=>{_(),t(),W(null),R("start")},[_,t]),k=Q.useCallback(()=>{B(!0)},[]),A=Q.useCallback(N=>{s(N),B(!1)},[s]),x=Q.useCallback(()=>{B(!1)},[]);return ae?C.jsx("div",{className:"min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900 flex flex-col items-center justify-center p-4",children:C.jsxs("div",{className:"animate-pulse",children:[C.jsx("h1",{className:"text-4xl md:text-6xl font-game text-sonic-gold drop-shadow-lg text-center",children:"Loading..."}),C.jsx("p",{className:"text-xl text-white mt-4 font-game text-center",children:e?"Loading heroes...":u?"Connecting to Sonic Speed!":"Loading your progress..."})]})}):!r&&$?C.jsx(BE,{onComplete:A,onCancel:x}):r?h?C.jsx("div",{className:"min-h-screen bg-gradient-to-b from-sonic-blue to-blue-900 flex flex-col items-center justify-center p-4",children:C.jsxs("div",{className:"text-center",children:[C.jsx("h1",{className:"text-4xl md:text-6xl font-game text-red-500 drop-shadow-lg",children:"Oops!"}),C.jsx("p",{className:"text-xl text-white mt-4 font-game",children:"Could not connect to save your progress"}),C.jsx("p",{className:"text-sm text-white mt-2 opacity-75",children:h.message}),C.jsx("button",{onClick:()=>R("game"),className:`mt-6 bg-sonic-gold text-sonic-blue font-game px-8 py-4 rounded-full
                       hover:bg-yellow-400 transform hover:scale-105 transition-all
                       shadow-lg active:scale-95 text-xl`,children:"Play Anyway!"})]})}):C.jsxs(C.Fragment,{children:[T==="start"&&C.jsx(OE,{onStart:ne,progress:m,onSwitchProfile:Te,activeProfile:r}),T==="game"&&C.jsx(DE,{onGameEnd:ue,updateProgress:g,initialProgress:m}),T==="result"&&z&&C.jsx(VE,{sessionStats:z,onPlayAgain:pe,onExit:Ce})]}):C.jsx(UE,{onCreateProfile:k})}function $E({children:r}){const[e,t]=Q.useReducer(kx,Px);Q.useEffect(()=>{const T=jy();t({type:It.SET_PROFILES,payload:T});const R=sessionStorage.getItem(ss);if(R){const z=T.find(W=>W.id===R)||null;z?t({type:It.SET_ACTIVE,payload:z}):sessionStorage.removeItem(ss)}},[]);const s=Q.useCallback(async(T,R)=>{if(!await Rx(R,T.pinHash))return!1;const W=zy(T.id,{});return t({type:It.SET_ACTIVE,payload:W}),sessionStorage.setItem(ss,T.id),!0},[]),o=Q.useCallback(()=>{t({type:It.CLEAR_ACTIVE}),sessionStorage.removeItem(ss)},[]),u=Q.useCallback(()=>{const T=jy();t({type:It.SET_PROFILES,payload:T})},[]),h=Q.useCallback(T=>{t({type:It.ADD_PROFILE,payload:T})},[]),m=Q.useCallback(T=>{t({type:It.ADD_PROFILE,payload:T}),t({type:It.SET_ACTIVE,payload:T}),sessionStorage.setItem(ss,T.id)},[]),g=Q.useCallback((T,R)=>{const z=zy(T,R);return t({type:It.UPDATE_PROFILE,payload:z}),z},[]),_=Q.useCallback(T=>{const R=Ax(T);return R&&(t({type:It.DELETE_PROFILE,payload:T}),sessionStorage.getItem(ss)===T&&sessionStorage.removeItem(ss)),R},[]),w=Q.useMemo(()=>({profiles:e.profiles,activeProfile:e.activeProfile,isLoading:e.isLoading,error:e.error,maxProfiles:Gd,selectProfile:s,clearActiveProfile:o,refreshProfiles:u,addProfile:h,createAndActivate:m,updateProfile:g,deleteProfile:_}),[e.profiles,e.activeProfile,e.isLoading,e.error,s,o,u,h,m,g,_]);return C.jsx(LE.Provider,{value:w,children:r})}$E.propTypes={children:ee.node.isRequired};o0.createRoot(document.getElementById("root")).render(C.jsx(Zw.StrictMode,{children:C.jsx($E,{children:C.jsx(Lx,{})})}));
